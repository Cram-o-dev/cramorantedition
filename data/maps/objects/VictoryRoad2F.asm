VictoryRoad2F_Object:
	...
	def_object_events
	object_event 12,  9, SPRITE_KOGA, STAY, LEFT, 1, OPP_BLACKBELT, 9
	...
	object_event 28,  3, SPRITE_SUPER_NERD, STAY, LEFT, 5, OPP_JUGGLER, 5
	...
	object_event 18, 16, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 13 ; person
