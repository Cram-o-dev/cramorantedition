HiddenObjectMaps:
	dbw PALLET_TOWN,				  PalletTownHiddenObjects
	dbw ROUTE_2, 					  Route2HiddenObjects
	dbw ROUTE_3, 					  Route3HiddenObjects
	dbw ROUTE_5, 					  Route5HiddenObjects
	dbw ROUTE_6, 					  Route6HiddenObjects
	...
	dbw SAFFRON_SHADY_HOUSE,          UnusedMap6FHiddenObjects
	...
	dbw SS_ANNE_BOW,              	  SSAnneBowHiddenObjects
	...
	dbw ROUTE_18,                     Route18HiddenObjects
	dbw ROUTE_22,					  Route22HiddenObjects
	dbw ROUTE_23,                     Route23HiddenObjects
	dbw VICTORY_ROAD_1F,              VictoryRoad1HiddenObjects
	dbw VICTORY_ROAD_2F,              VictoryRoad2HiddenObjects
	dbw VICTORY_ROAD_3F,			  VictoryRoad3HiddenObjects
	...
	dbw ROUTE_8,                      Route8HiddenObjects
	...
	dbw SAFFRON_CITY,                 SaffronCityHiddenObjects
	...
	dbw LAVENDER_TOWN,          	  LavenderTownHiddenObjects
	dbw POKEMON_TOWER_4F,             Pokemontower4HiddenObjects
	...
	dbw VERMILION_DOCK,         	  VermilionDockHiddenObjects
	...
	dbw FUCHSIA_CITY,           	  FuchsiaCityHiddenObjects
	...
	dbw WAY_OF_FISH_BF,          	  WayOfFishBFHiddenObjects
...
PalletTownHiddenObjects:
	hidden_object  9,  7, RARE_CANDY, HiddenItems
	db -1 ; end
	
Route2HiddenObjects:
	hidden_object 14,  3, NUGGET, HiddenItems
	db -1 ; end
	
Route3HiddenObjects:
	hidden_object 44, 13, ETHER, HiddenItems
	db -1 ; end
	
Route5HiddenObjects:
	hidden_object  1, 32, RARE_CANDY, HiddenItems
	db -1 ; end
	
Route6HiddenObjects:
	hidden_object 17,  5, SAFARI_BALL, HiddenItems
	hidden_object  3,  5, SAFARI_BALL, HiddenItems
	db -1 ; end
...
Mansion2HiddenObjects:
	...
	hidden_object 13, 14, FIRE_STONE, HiddenItems
	db -1 ; end
...
ViridianForestHiddenObjects:
	...
	hidden_object 14, 23, LEAF_STONE, HiddenItems
	db -1 ; end
...
SSAnneBowHiddenObjects:
	hidden_object  0,  6, RARE_CANDY, HiddenItems
	db -1 ; end
...
RockTunnelB1FHiddenObjects:
	hidden_object 20,  8, HP_UP, HiddenItems
	hidden_object  1, 25, CALCIUM, HiddenItems
	hidden_object  1, 31, CARBOS, HiddenItems
	db -1 ; end
...
Route10HiddenObjects:
	hidden_object  8, 25, SUPER_POTION, HiddenItems
	hidden_object 16, 53, MAX_ETHER, HiddenItems
	hidden_object  4, 19, ULTRA_BALL, HiddenItems
	db -1 ; end
...
Route16HiddenObjects:
	hidden_object  1,  2, MAX_ELIXER, HiddenItems
	db -1 ; end
...
Route18HiddenObjects:
	hidden_object 28,  8, MASTER_BALL, HiddenItems
	db -1 ; end
	
Route22HiddenObjects:
	hidden_object 30,   2, POTION, HiddenItems
	db -1 ; end
...
Route23HiddenObjects:
	...
	hidden_object 11, 50, MAX_REVIVE, HiddenItems
	db -1 ; end
...
VictoryRoad3HiddenObjects:
	hidden_object  3,  3, MAX_ELIXER, HiddenItems
	db -1 ; end
...
Route4HiddenObjects:
	...
	hidden_object 74,  9, PROTEIN, HiddenItems
	db -1 ; end
...
Route8HiddenObjects:
	hidden_object 52,  3, ULTRA_BALL, HiddenItems
	hidden_object 33, 14, NUGGET, HiddenItems
	hidden_object  9,  6, RARE_CANDY, HiddenItems
	db -1 ; end

Route9HiddenObjects:
	hidden_object 14,  7, ETHER, HiddenItems
	hidden_object 45, 12, NUGGET, HiddenItems
	db -1 ; end
...
SaffronCityHiddenObjects:
	hidden_object 28, 23, POKE_DOLL, HiddenItems
	hidden_object 14, 19, MASTER_BALL, HiddenItems
	db -1 ; end
...
PewterCityHiddenObjects:
	hidden_object  8,  2, MOON_STONE, HiddenItems
	hidden_object 24,  2, GREAT_BALL, HiddenItems
	db -1 ; end
...
CeruleanCityHiddenObjects:
	...
	hidden_object 23,  3, IRON, HiddenItems
	db -1 ; end
...
LavenderTownHiddenObjects:
	hidden_object  1,  1, SAFARI_BALL, HiddenItems
	db -1 ; end
	
Pokemontower4HiddenObjects:
	hidden_object  5,  4, HYPER_POTION, HiddenItems
	db -1 ; end
...
DiglettsCaveHiddenObjects:
	hidden_object 12, 19, LINK_CABLE, HiddenItems
	db -1 ; end

VermilionCityHiddenObjects:
	hidden_object 14, 19, MAX_ETHER, HiddenItems
	db -1 ; end
...
VermilionDockHiddenObjects:
	hidden_object 10,  4, MASTER_BALL, HiddenItems
	db -1 ; end
...
CeladonCityHiddenObjects:
	...
	hidden_object 37, 33, LEMONADE, HiddenItems
	hidden_object  9,  4, RARE_CANDY, HiddenItems
	hidden_object 48,  8, SAFARI_BALL, HiddenItems
	db -1 ; end
...
FuchsiaCityHiddenObjects:
	hidden_object 36, 34, SAFARI_BALL, HiddenItems
	hidden_object 27, 23, SAFARI_BALL, HiddenItems
	hidden_object 15, 21, SAFARI_BALL, HiddenItems
	hidden_object 22,  1, SAFARI_BALL, HiddenItems
	hidden_object 36, 11, SAFARI_BALL, HiddenItems
	db -1 ; end
...
SafariZoneEntranceHiddenObjects:
	hidden_object  5,  4, NUGGET, HiddenItems
	db -1 ; end
...
WayOfFishBFHiddenObjects:
	hidden_object  9,  1, MASTER_BALL, HiddenItems
	db -1 ; end
