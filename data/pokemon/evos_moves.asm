...
EvosMovesPointerTable:
	...
	dw DiglettEvosMoves
	dw TaurosEvosMoves
	dw ArrokudaEvosMoves
	dw BaraskewdaEvosMoves
...
; Evolutions
	db EV_ITEM, THUNDER_STONE, 1, RAICHU
	db EV_ITEM, FIRE_STONE, 1, RAICHU
	db EV_ITEM, WATER_STONE, 1, RAICHU
	db EV_ITEM, LEAF_STONE, 1, RAICHU
	db EV_ITEM, MOON_STONE, 1, RAICHU
	db EV_ITEM, LINK_CABLE, 1, RAICHU
	db 0
; Learnset
	db 6, WATER_GUN
	db 10, GUST
