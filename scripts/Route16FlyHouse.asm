...
Route16HouseTradeGuy:
	text_asm
	ld a, TRADE_FOR_MARTY
	ld [wWhichTrade], a
	predef DoInGameTradeDialogue
	ld hl, Route16HouseTradeGuy_TextScriptEndingText
	ret