...
Route10Hermit:
	...
	jr nz, .got_item
	ld hl, CoinPreReceiveText
	call PrintText
	lb bc, COIN, 1
	call GiveItem
	jr nc, .bag_full
	ld hl, ReceivedCoinText
	call PrintText
	SetEvent EVENT_GOT_COIN
	jr .done
.bag_full
	ld hl, CoinNoRoomText
	call PrintText
	jr .done
.got_item
	ld hl, CoinExplanationText
	call PrintText
.done
	jp TextScriptEnd

CoinPreReceiveText:
	text_far _CoinPreReceiveText
	text_end

ReceivedCoinText:
	text_far _ReceivedCoinText
	sound_get_item_1
	text_end

CoinExplanationText:
	text_far _CoinExplanationText
	text_end
