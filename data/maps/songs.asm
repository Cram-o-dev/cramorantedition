MapSongBanks::
	...
	db MUSIC_ROUTES4, BANK(Music_Routes3) ; ROUTE_19
	db MUSIC_ROUTES4, BANK(Music_Routes3) ; ROUTE_20
	db MUSIC_ROUTES4, BANK(Music_Routes3) ; ROUTE_21
	...
	db MUSIC_DIGDA, BANK(Music_Digda) ; DIGLETTS_CAVE_ROUTE_2
	...
	db MUSIC_DIGDA, BANK(Music_Digda) ; DIGLETTS_CAVE_ROUTE_11
	db MUSIC_DIGDA, BANK(Music_Digda) ; ROUTE_11_GATE_2F
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; TM_PLACE
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; UNUSED_MAP_6A
	db MUSIC_SS_ANNE, BANK(Music_SSAnne) ; UNUSED_MAP_6B
	db MUSIC_VICTORY_ROAD, BANK(Music_VictoryRoad) ; VICTORY_ROAD_1F
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; WAY_OF_FISH_1F
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; WAY_OF_FISH_BF
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; SAFFRON_SHADY_HOUSE
	db MUSIC_ROUTES4, BANK(Music_Routes3) ; ROUTE_21_HOUSE
	...
	db MUSIC_VICTORY_ROAD, BANK(Music_VictoryRoad) ; VICTORY_ROAD_2F
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_12_GATE_2F
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; VERMILION_TRADE_HOUSE
	db MUSIC_DIGDA, BANK(Music_Digda) ; DIGLETTS_CAVE
	db MUSIC_VICTORY_ROAD, BANK(Music_VictoryRoad) ; VICTORY_ROAD_3F
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; VIRIDIAN_FOREST_HOUSE
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; VERMILION_CITY_SOLO_GUY_HOUSE
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ; CRAMORANT_FAN_CLUB
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CERULEAN_CAVE_B4F
	...
	db MUSIC_ROUTES4, BANK(Music_Routes3) ; SUMMER_BEACH_HOUSE
