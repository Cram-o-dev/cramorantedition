...
_PikachuDexEntry::
	text "It's so strong,"
	next "it can knock out"
	next "foes in one hit."

	page "However, it may"
	next "forget what it's"
	next "battling midfight"
	dex
	
_ArrokudaDexEntry::
	text "After it's eaten"
	next "its fill, its mov-"
	next "ement is sluggish."

	page "That's when"
	next "CRAMORANT swallows"
	next "it up"
	dex
	
_BaraskewdaDexEntry::
	text "It spins its tail"
	next "fins to propel it-"
	next "self at 100 knots."

	page "It uses its incre-"
	next "dible speed to ram"
	next "and spear prey"
	dex