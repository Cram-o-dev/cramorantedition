...
LeafStonePreReceiveText:
	text_far _LeafStonePreReceiveText
	text_end

ReceivedLeafStoneText:
	text_far _ReceivedLeafStoneText
	sound_get_item_1
	text_end

LeafStoneExplanationText:
	text_far _LeafStoneExplanationText
	text_end

LeafStoneNoRoomText:
	text_far _LeafStoneNoRoomText
	text_end
