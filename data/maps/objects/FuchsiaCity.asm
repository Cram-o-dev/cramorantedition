FuchsiaCity_Object:
	...
	def_bg_events
	bg_event 25, 15, 12 ; FuchsiaCityText11
	...
	bg_event 31,  7, 19 ; FuchsiaCityText19
	bg_event 27,  7, 20 ; FuchsiaCityText20
	bg_event 13,  7, 21 ; FuchsiaCityText21
	bg_event 33, 13, 22 ; FuchsiaCityText22
	bg_event 13, 15, 23 ; FuchsiaCityText23
	bg_event  7,  7, 24 ; FuchsiaCityText24
	bg_event 19, 13, 25 ; FuchsiaCityPettingZooText

	def_object_events
	object_event 10, 12, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, 1 ; person
	object_event 28, 17, SPRITE_GAMBLER, WALK, LEFT_RIGHT, 2 ; person
	object_event 34, 14, SPRITE_FISHER, STAY, DOWN, 3 ; person
	object_event 27,  6, SPRITE_YOUNGSTER, STAY, LEFT, 4 ; person
	object_event 33,  5, SPRITE_CHANSEY, STAY, ANY_DIR, 5 ; person
	object_event 25,  5, SPRITE_POKE_BALL, WALK, LEFT_RIGHT, 6 ; person
	...
	object_event 16, 10, SPRITE_COOLTRAINER_M, WALK, ANY_DIR, 26 ; person
