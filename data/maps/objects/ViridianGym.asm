ViridianGym_Object:
	...
	object_event 11, 11, SPRITE_KOGA, STAY, UP, 3, OPP_BLACKBELT, 6
	object_event 10,  7, SPRITE_ROCKER, STAY, DOWN, 4, OPP_TAMER, 3
	object_event  3,  7, SPRITE_KOGA, STAY, LEFT, 5, OPP_BLACKBELT, 7
	object_event 13,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, 6, OPP_COOLTRAINER_M, 10
	object_event 10,  1, SPRITE_KOGA, STAY, DOWN, 7, OPP_BLACKBELT, 8
