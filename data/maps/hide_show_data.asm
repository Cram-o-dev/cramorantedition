...
; entries correspond to map ids
	...
	dw NoHS
	dw NoHS
	dw NoHS ; Viridian Forest House
	dw NoHS ; Vermilion City Solo Guy House
	dw NoHS ; Cramorant Fan Club
	dw CeruleanCaveB4FHS
	dw NoHS
	dw NoHS
	dw NoHS
	dw NoHS
...
SaffronShadyHouseHS:
	db SAFFRON_SHADY_HOUSE, $01, SHOW
	db SAFFRON_SHADY_HOUSE, $02, SHOW
	db SAFFRON_SHADY_HOUSE, $07, HIDE
	db SAFFRON_SHADY_HOUSE, $08, HIDE
ChampionsRoomHS:
