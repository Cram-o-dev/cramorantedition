...
; TODO: mark sprite constants with an X that are never used
	...
	const HS_WAY_OF_FISH_BF_ARROKUDA
	const HS_SAFFRON_SHADY_HOUSE_GUY1
	const HS_SAFFRON_SHADY_HOUSE_GUY2
	const HS_SAFFRON_SHADY_HOUSE_GUY3
	const HS_SAFFRON_SHADY_HOUSE_GUY4
