...
; Route 7 events
	const_next $420
	const_skip
	const EVENT_BEAT_WAY_OF_FISH_BF_TRAINER_0
	const EVENT_BEAT_WAY_OF_FISH_BF_TRAINER_1
	const EVENT_BEAT_WAY_OF_FISH_BF_TRAINER_2
...
; Cerulean Cave events
	...
	const EVENT_BEAT_CERULEAN_CAVEB4F_TRAINER_0
	const EVENT_GOT_PP_UP
	const EVENT_PP_UP_REWARD_AVAILABLE
