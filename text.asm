...
INCLUDE "text/CeruleanCaveB4F.asm"
INCLUDE "text/ViridianForestHouse.asm"
INCLUDE "text/VermilionCitySoloGuyHouse.asm"
...
INCLUDE "text/WayOfFish1F.asm"
INCLUDE "text/WayOfFishBF.asm"
INCLUDE "text/TMPlace.asm"
INCLUDE "text/PokemonMansion1F.asm"
INCLUDE "text/SaffronShadyHouse.asm"
INCLUDE "text/Route21House.asm"
