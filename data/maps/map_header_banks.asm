...
MapHeaderBanks::
	...
	db BANK(WayOfFish1F_h)
	db BANK(WayOfFishBF_h)
	db BANK(SaffronShadyHouse_h)
	db BANK(Route21House_h)
	...
	db BANK(Colosseum_h)
	db BANK(ViridianForestHouse_h)
	db BANK(VermilionCitySoloGuyHouse_h)
	db BANK(CramorantFanClub_h)
	db BANK(CeruleanCaveB4F_h)
