...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_EXECUTIVE_PRODUCER, CRED_YAMAUCHI, CRED_TEXT_MON
	db CRED_CRAM, CRED_CREATED_BY, CRED_MADE_BY, CRED_TEXT_FADE_MON
	db CRED_EXTRA_THANKS, CRED_FRIENDS2, CRED_ORANGE, CRED_TEXT_FADE
	db CRED_EXTRA_THANKS, CRED_VORTYNE, CRED_DOURY, CRED_TEXT
	db CRED_FRIENDS, CRED_PRET, CRED_COMMUNITY, CRED_BETA_TESTERS, CRED_TEXT_FADE_MON
