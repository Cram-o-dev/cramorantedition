SuperRodFishingSlots::
	db PALLET_TOWN, STARYU, 10, TENTACOOL, 10, STARYU, 5, TENTACOOL, 20, ARROKUDA, 30
	...
	db ROUTE_12, HORSEA, 20, HORSEA, 25, ARROKUDA, 20, ARROKUDA, 22, SEADRA, 25, SEADRA, 35
	db ROUTE_13, HORSEA, 15, HORSEA, 20, TENTACOOL, 10, ARROKUDA, 20, SEADRA, 20
	db ROUTE_17, TENTACOOL, 5, TENTACOOL, 15, SHELLDER, 25, SHELLDER, 35
	db ROUTE_18, TENTACOOL, 15, SHELLDER, 20, SHELLDER, 30, SHELLDER, 40
	db ROUTE_19, TENTACOOL, 15, STARYU, 20, TENTACOOL, 30, BARASKEWDA, 30, TENTACRUEL, 30
	db ROUTE_20, TENTACOOL, 20, TENTACRUEL, 20, STARYU, 30, TENTACRUEL, 40, BARASKEWDA, 40
	db ROUTE_21, TENTACOOL, 15, STARYU, 20, TENTACOOL, 30, BARASKEWDA, 30, TENTACRUEL, 30
	db ROUTE_22, POLIWAG, 5, POLIWAG, 10, POLIWAG, 15, POLIWHIRL, 15
	db ROUTE_23, POLIWAG, 25, POLIWAG, 30, POLIWHIRL, 30, POLIWHIRL, 40, BARASKEWDA, 45
	db VERMILION_DOCK, TENTACOOL, 10, TENTACOOL, 15, STARYU, 15, SHELLDER, 10
	db SAFARI_ZONE_CENTER, MAGIKARP, 5, MAGIKARP, 10, DRATINI, 15, DRAGONAIR, 35
	db SAFARI_ZONE_EAST, MAGIKARP, 5, MAGIKARP, 10, MAGIKARP, 15, DRATINI, 25
	db SAFARI_ZONE_NORTH, MAGIKARP, 5, MAGIKARP, 10, MAGIKARP, 15, DRATINI, 25
	db SAFARI_ZONE_WEST, MAGIKARP, 5, MAGIKARP, 10, MAGIKARP, 15, DRATINI, 25
