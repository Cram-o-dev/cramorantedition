...
; entries correspond to CRED_* constants
	...
	dw CreditsText_Cram
	dw CreditsText_CreatedBy
	dw CreditsText_MadeBy
	dw CreditsText_ExtraThanks
...
CreditsText_Yamazaki:
	db -6, "SAKAE YAMAZAKI@"
CreditsText_Cram:
	db -9, "  CRAMORANT EDITION@"
CreditsText_CreatedBy:
	db -5, " CREATED BY@"
CreditsText_MadeBy:
	db -5, " CRAM-O-DEV@"
CreditsText_ExtraThanks:
	db -6, "SPECIAL THANKS@"
CreditsText_Friends2:	
...
CreditsText_Pret:
	db -6, "ALL PRET STAFF@"
CreditsText_Community:
	db -4, "COMMUNITY@"
CreditsText_BetaTesters:
	db -8, " AND BETA TESTERS!@"